        ...
        <div id="header">
            ...
            <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
                            <li><a href="re90rt.php">All Voters</a></li>
                            <li><a href="e26c87re90rt.php">Electoral Commission</a></li>
                            <li><a href="can31di45re90rt.php">Candidates</a></li>
                            <li><a href="#">Total Votes</a></li>
                        </ul>
