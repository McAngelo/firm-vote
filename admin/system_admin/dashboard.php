	...
	<body>
		...
		<div class="container_12">
            ...
            <div class="grid_7">
                ...
                <a href="voting_report/votein9ro.php" class="dashboard-module">
            ...
            <div class="grid_12">
               ...
               <?php
			   			...
			   			$all_voters = mysqli_query($connection, "SELECT * FROM electrates_tbl");
						$total_voters = mysqli_num_rows($all_voters);
               ...
               <?php
			   			...
			   			$all_positions = mysqli_query($connection, "SELECT * FROM  position_tbl");
						$total_positions = mysqli_num_rows($all_positions);
			   ...
			   ?>
                 <?php
			   			...
			   			$all_candidates = mysqli_query($connection, "SELECT * FROM  candidates_tbl");
						$total_candidates = mysqli_num_rows($all_candidates);
               ...
               <?php
			   			...
			   			$all_levels = mysqli_query($connection, "SELECT * FROM  level_tbl");
						$total_levels = mysqli_num_rows($all_levels);
